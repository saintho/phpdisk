...
// Cache Time:2015-09-27 16:57:32
...
<?php if($action=='list'){ ?>
<div id="container">
<h1><?=__('vip_manage')?><?php sitemap_tag(__('vip_manage')); ?></h1>
<div>
...
<tr>
	<td>&nbsp;</td>
	<td><input type="submit" class="btn" <?php if(get_active_users($vip_id) && $action=='edit'){ ?>onclick="return confirm('<?=__('vip_has_user_edit')?>');"<?php } ?> value="<?=__('btn_submit')?>"/>&nbsp;
