...
// Cache Time:2015-09-27 16:22:18
...
<?php if($action =='index'){ ?>
<div id="container">
<h1><?=__('user_group_list')?><?php sitemap_tag(__('user_group_list')); ?></h1>
<div>
...
<?php }elseif($action =='group_create' || $action =='group_modify'){ ?>
<div id="container">
...
<?php }elseif($action =='group_setting'){ ?>
<div id="container">
