...
// Cache Time:2015-09-27 16:25:41
...
<?php if($action =='backup' || $action =='optimize'){ ?>
<div id="container">
<?php if($action =='backup'){ ?>
<h1><?=__('backup_database')?><?php sitemap_tag(__('backup_database')); ?></h1>
<div>
...
<?php }else{ ?>
<h1><?=__('optimize_database')?><?php sitemap_tag(__('optimize_database')); ?></h1>
<div>
...
<div id="container">
<h1><?=__('restore_database')?><?php sitemap_tag(__('restore_database')); ?></h1>
<div>
