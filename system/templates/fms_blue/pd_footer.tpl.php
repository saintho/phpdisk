...
// Cache Time:2015-09-26 17:55:04
...
<?php require_once template_echo('sub/block_navigation_bottom','templates/fms_blue/'); ?>
<?=$contact_us?><?=$miibeian?><?=$site_stat?>
<?php require_once template_echo('sub/block_lang_tpl_switch','templates/fms_blue/'); ?>
...
<?=PHPDISK_EDITION?> v<?=PHPDISK_VERSION?> 2008-<?=NOW_YEAR?> &copy; All Rights Reserved.<?php require_once template_echo('sub/block_license','templates/fms_blue/'); ?></div>
</div>
<br />
</body>
</html>
