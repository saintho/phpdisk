...
<div id="dl_box">
	...
	<div id="b2">
<?php if($settings[down_auth_code]==1 && $file[file_downs]>=$settings[file_downs]){ ?>
...
<div style="padding:10px 0"><input type="button" onclick="check_yuc();" id="s1" class="btn txtblue" value="<?=__('auth_down_submit')?>" />&nbsp;&nbsp;<img src="images/code_tips.gif" align="absmiddle" border="0" /></div>
</form>
<?php }elseif($settings[down_auth_code]==2 && $file[file_downs]>=$settings[file_downs]){ ?>
<div id="code_box">
<form id="codefrm" method="post" onkeydown="if(event.keyCode==13){return false;}">
...
<?php }elseif($settings[down_auth_code]==3 && $file[file_downs]>=$settings[file_downs]){ ?>
<form id="codefrm" method="post" onkeydown="if(event.keyCode==13){return false;}">
...
<?php } ?>
<?php if($settings['open_thunder']){ ?>
<script src="http://pstatic.xunlei.com/js/webThunderDetect.js"></script>
<?php } ?>
<?php if($settings['open_flashget']){ ?>
...
<div class="r">
<?php require_once template_echo('sub/block_download_side','templates/fms_blue/'); ?>
<?php show_adv_data('adv_download_side'); ?>
</div>
<script type="text/javascript">
<?php if(!$settings[down_auth_code] || $file[file_downs]<$settings[file_downs]){ ?>
document.getElementById('down_box').style.display="";
document.getElementById('down_box2').style.display ='none';
<?php } ?>
