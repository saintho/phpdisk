...
// Cache Time:2015-09-23 21:59:11
...
<?php if($settings[open_index_fast_upload_box] && !$settings['close_guest_upload']){ ?>
<?php if($upload_remote){ ?>
...
<?php } ?>
<?php } ?>
<?php if($settings[open_index_site_desc]){ ?>
...
<?php } ?>
<?php if($settings[open_index_file_list]){ ?>
<Br />
<div class="idx_tips_box_file_index">
<?php require_once template_echo('sub/block_hot_last_file','templates/default/'); ?>
</div>
<?php } ?>
<div class="clear"></div>
<br /><br /><br /><br />
<?php if($settings[open_index_fast_upload_box] && !$settings['close_guest_upload']){ ?>
<?php if($show_multi && $pd_uid){ ?>
