...
#
#	$Id: imagecode.php 121 2014-03-04 12:38:05Z along $
#
...
class cls_imagecode {
	//验证码的session的下标
	public static $seKey = 'my_imgcode';   //验证码关键字
	public static $expire = 3000;     // 验证码过期时间（s）
	//验证码中使用的字符，01IO容易混淆，不用
	public static $codeSet = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
	public static $fontSize = 40;     // 验证码字体大小(px)
	...
	public static function entry() {
		...
		//$ttf = 'images/fonts/f' . mt_rand(1, 8) . '.ttf';
		$ttf = 'images/fonts/f1.ttf';
...
cls_imagecode::$useNoise = true;  //是否启用噪点
cls_imagecode::$useCurve = true;   //是否启用干扰曲线
cls_imagecode::entry();
