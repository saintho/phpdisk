...
$p2_Order					= get_order_number();//$_REQUEST['p2_Order'];
...
$p8_Url						= $settings['phpdisk_url'].'payment.php?action=yeepay';//$_REQUEST['p8_Url'];
...
$num = @$db->result_first("select count(*) from {$tpf}vip_orders where order_number='$p2_Order' and pay_method='yeepay' and userid='$pd_uid'");
if(!$num){
	$ins = array(
	'pay_method' => 'yeepay',
	'userid' => $pd_uid,
	'vip_id' => (int)$_GET[vip_id],
	'order_number' => $p2_Order,
	'total_fee' => $p3_Amt,
	'pay_status' => 'pendding',
	'in_time' => $timestamp,
	'ip' => $onlineip,
