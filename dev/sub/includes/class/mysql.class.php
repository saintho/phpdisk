...
#
#	$Id: mysql.class.php 14 2013-03-18 03:02:57Z along $
#
...
class cls_mysql{
	...
	function error ($s){
		...
		$rtn .= '<p><a href="http://faq.phpdisk.com/search?w='.rawurlencode($s).'" target="_blank">[<span style="color:#FF0000;">PHPDisk error!</span>]&nbsp;'.$s.'</a><br><br>';
		$rtn .= $mysql_error.'<br>';
		$rtn .= $mysql_errno.'</p></div>';
		return $rtn;
	}
	// add for phpwind
