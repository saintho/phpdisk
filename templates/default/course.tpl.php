...
<!--#if($action =='modify_course' || $action=='add_course'){#-->
<div id="container">
<div class="box_style">
		...
		<table align="center" width="100%" cellpadding="4" cellspacing="0" border="0" class="file_table">
			...
			#-->
				...
				<tr>
					<td width="30%" class="">
						<!--# echo str_repeat('&nbsp;',$v['level']*2)#-->
						<input type="checkbox" name="file_ids[]" id="file_ids" value="{$v['file_id']}" <!--# if(in_array($v['file_id'],$user_select_file)){echo 'checked';} #-->>
						{$v['file_name']}
					</td>
