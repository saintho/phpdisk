...
<div id="container">
<h1><?=__('admins_setting')?><!--#sitemap_tag(__('admins_setting'));#--></h1>
<div>
<div class="tips_box"><img class="img_light" src="images/light.gif" align="absmiddle" /> <b><?=__('tips')?>: </b>
...
<!--#}elseif($action =='add_admins' || $action=='edit_admins'){#-->
<div id="container">
<h1><?=__('admins_setting')?><!--#sitemap_tag(__('admins_setting'));#--></h1>
<div>
<div class="tips_box"><img class="img_light" src="images/light.gif" align="absmiddle" /> <b><?=__('tips')?>: </b>
...
<tr>
	...
	<td><input type="text" name="username" value="{$pa[username]}" <!--#if($action=='edit_admins'){echo 'readonly';}#--> /></td>
</tr>
<tr>
	<td><b><?=__('admin_password')?></b>:<br /><span class="txtgray"><?=__('admin_password_tips')?></span></td>
	<td><input type="text" name="password" value="" maxlength="50" />&nbsp;<!--#if($action=='edit_admins'){echo '<span class="txtred">'.__('admin_password_tips2').'</span>';}#--></td>
</tr>
</table>
...
<!--#}elseif($action =='back_pwd'){#-->
<div id="container">
<h1><?=__('back_pwd')?><!--#sitemap_tag(__('back_pwd'));#--></h1>
<div>
<div class="tips_box"><img class="img_light" src="images/light.gif" align="absmiddle" /> <b><?=__('tips')?>: </b>
...
<tr>
	<td>&nbsp;</td>
	<td><input type="submit" class="btn" value="<!--#if(!super_admin()){#--><?=__('btn_modify')?><!--#}else{#--><?=__('btn_submit')?><!--#}#-->"/></td>
</tr>
</table>
</form>
</div>
