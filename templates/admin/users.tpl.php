...
<tr>
	...
	<?=__('user_credit')?>：<input type="text" name="credit" value="{$myinfo['credit']}" size="10" maxlength="10" />
		<!--#if($auth[open_discount]){#--><span class="txtred" title="<?=__('discount_show')?>">{#get_discount($user[userid],$myinfo[credit])#}</span>&nbsp;<!--#}#-->
	
	<?=__('downline_credit')?>：<input type="text" name="dl_credit" value="{$myinfo['dl_credit']}" size="10" maxlength="10" />
	<!--#if($auth[open_downline2]){#-->二级下线积分：<input type="text" name="dl_credit2" value="{$myinfo['dl_credit2']}" size="10" maxlength="10" /><!--#}#-->
	</td>
</tr>
<tr>
	<td><span class="bold"><?=__('user_income_rate')?>:</span><br /><span class="txtgray"><?=__('user_income_rate_tips')?></span></td>
	...
	<!--#if($curr_credit_rate){#--><span class="txtred"><?=__('rate_set')?>:{$curr_credit_rate}</span><!--#}#--><br />
	</td>
</tr>
...
<tr>
	...
	<!--#if($curr_discount_rate){#--><span class="txtred"><?=__('curr_user_discount_rate')?>:{$curr_discount_rate}</span><!--#}#-->&nbsp;&nbsp;
	<!--#if($add_discount){#--><span class="txtblue"><?=__('edit_user_discount_rate_credit')?>:{$add_discount}</span><!--#}#-->
	<br />
	</td>
</tr>
<!--#}#-->
<tr>
	...
	<!--#if($curr_downline_rate){#--><span class="txtred"><?=__('rate_set')?>:{$curr_downline_rate}</span><!--#}#--><br />
	</td>
</tr>
...
<tr>
	...
	<!--#if($curr_downline_rate2){#--><span class="txtred"><?=__('rate_set')?>:{$curr_downline_rate2}</span><!--#}#--><br />
	</td>
</tr>
<!--#}#-->
<!--#if($auth[space_pwd]){#-->
