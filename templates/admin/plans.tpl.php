...
<!--#if($action=='list'){#-->
<div id="container">
<h1><?=__('earn_plans_manage')?><!--#sitemap_tag(__('earn_plans'));#--></h1>
<div>
...
<tr>
	...
	<td align="right">
	<!--#if($auth[plan_set_default]){#-->{$v[is_default]}<!--#}#-->
...
<tr>
	...
	<input type="submit" class="btn" value="<?=__('btn_submit')?>" <!--#if(get_plan_users($plan_id)){#--> onclick="return confirm('<?=__('plans_has_user')?>')" <!--#}#-->/>&nbsp;
