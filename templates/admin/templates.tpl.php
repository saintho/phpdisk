...
<tr class="{$color}">
	...
	<table>
		...
		<tr>
			<td><!--#if($v[authed_tpl]==2){#--><span class="txtgreen">此模板授权检测成功，可直接使用</span><!--# }elseif($v[authed_tpl]==1){#--><span class="txtred">此模板或对应域名未授权，暂时无法使用</span><!--#}#--></td>
		</tr>
		<tr>
			<td>	
	...
	<td align="right">
	<!--#if($v[authed_tpl]==2 || !$v[authed_tpl]){#-->
	<!--# if($v['actived']){#-->
