...
<!--#if($action=='stat_day' || $action=='stat_hour' || $action=='stat_user'){#-->
...
<tr>
	...
	<td class="bold"><a href="{$v_url}">浏览数{$v_add}</a><!--#if($action<>'stat_hour'){#-->/扣量后<!--#}#--></td>
	<td class="bold" width="20%"><a href="{$d_url}">下载次数{$d_add}</a><!--#if($action<>'stat_hour'){#-->/扣量后<!--#}#--></td>
	<td class="bold" width="20%">分成金额<!--#if($action<>'stat_hour'){#-->/扣量后<!--#}#--></td>
	<!--#if($action=='stat_user'){#-->
...
<tr class="{$color}">
	...
	<td><!--#echo round($v['downs']/$v['views'],4)#--></td>
