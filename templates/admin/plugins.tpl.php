...
<!--#if($action =='shortcut'){#-->
<div id="container">
<h1><?=__('plugin_shortcut')?><!--#sitemap_tag(__('plugin_shortcut'));#--></h1>
<div>
...
<div id="container">
<h1><?=__('plugins_manage')?><!--#sitemap_tag(__('plugins_manage'));#--></h1>
<div>
<div class="tips_box"><img class="img_light" src="images/light.gif" align="absmiddle" /> <b><?=__('tips')?>: </b>
